alter table public.dashboard_keyword_daily
  drop constraint if exists dashboard_keyword_daily_client_id_source_account_id_keyword_key;

alter table public.dashboard_keyword_daily
  add constraint dashboard_keyword_daily_natural_key
  unique (
    client_id,
    source,
    account_id,
