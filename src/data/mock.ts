...
const entity = (
  ...
  item_name: name,
  item_status: "ENABLED",
  parent_id: parentId ?? (parentName ? `parent-${id}` : null),
...
export const mockEntities: Record<string, CursorPage<EntityItem>> = {
  ...
  google_group: {
    ...
    next_cursor: null,
    items: [
      entity("google_ads", "group", "gg1", "Marca + Maria Gasolina", 198.22, 910, 41, 5, "MG | SEARCH | MAX.CONV | CONDOMÍNIOS", "g1"),
      entity("google_ads", "group", "gg2", "Franquia de conveniência", 174.5, 1050, 59, 4, "MG | SEARCH | MAX.CONV | FRANQUIA", "g2"),
      entity("google_ads", "group", "gg3", "Mercado autônomo", 151.32, 978, 48, 6, "MG | SEARCH | MAX.CONV | FRANQUIA", "g2"),
      entity("google_ads", "group", "gg4", "Indicação de síndicos", 117.22, 890, 26, 3, "MG | SEARCH | MAX.CLIQUES | INDICAÇÃO", "g3"),
      entity("google_ads", "group", "gg5", "Condomínios", 112.18, 840, 37, 4, "MG | SEARCH | MAX.CONV | CONDOMÍNIOS", "g1"),
      entity("google_ads", "group", "gg6", "Express | Geral", 106.96, 1665, 137, 31, "MG | PERFORMANCE MAX | EXPRESS", "g4"),
    ],
  },
  google_keyword: {
    total_count: 12,
    next_cursor: null,
    items: [
      entity("google_ads", "keyword", "kw1", "[maria gasolina]", 98.42, 812, 55, 7, "Marca + Maria Gasolina", "gg1"),
      entity("google_ads", "keyword", "kw2", "[mercado em condomínio]", 87.31, 760, 44, 5, "Condomínios", "gg5"),
      entity("google_ads", "keyword", "kw3", "\"franquia de mercado\"", 76.18, 642, 38, 4, "Franquia de conveniência", "gg2"),
      entity("google_ads", "keyword", "kw4", "[mercado 24 horas]", 63.8, 526, 31, 4, "Express | Geral", "gg6"),
      entity("google_ads", "keyword", "kw5", "\"minimercado autônomo\"", 54.92, 418, 25, 3, "Mercado autônomo", "gg3"),
      entity("google_ads", "keyword", "kw6", "[loja de conveniência condomínio]", 48.77, 392, 22, 3, "Condomínios", "gg5"),
      entity("google_ads", "keyword", "kw7", "\"franquia de conveniência\"", 43.66, 344, 19, 2, "Franquia de conveniência", "gg2"),
      entity("google_ads", "keyword", "kw8", "[maria gasolina express]", 38.42, 315, 18, 2, "Marca + Maria Gasolina", "gg1"),
      entity("google_ads", "keyword", "kw9", "\"mercado no condomínio\"", 34.18, 278, 16, 2, "Condomínios", "gg5"),
      entity("google_ads", "keyword", "kw10", "[mini mercado condomínio]", 29.65, 242, 13, 1, "Condomínios", "gg5"),
      entity("google_ads", "keyword", "kw11", "\"mercado autônomo\"", 24.31, 198, 11, 1, "Mercado autônomo", "gg3"),
      entity("google_ads", "keyword", "kw12", "[franquia maria gasolina]", 18.67, 151, 8, 1, "Franquia de conveniência", "gg2"),
    ],
  },
  meta_campaign: {
    total_count: 5,
  ...
  meta_group: {
    ...
    next_cursor: null,
    items: [
      entity("meta_ads", "group", "mg1", "Síndicos | Sudeste | 30-60", 312.2, 15840, 152, 28, "MG | LEADS | CBO | CONDOMÍNIOS", "m1"),
      entity("meta_ads", "group", "mg2", "Franqueados | Lookalike 2%", 294.5, 14320, 163, 24, "MG | LEADS | CBO | FRANQUIA | POSTS", "m2"),
      entity("meta_ads", "group", "mg3", "Empreendedores | Interesses", 281.04, 13910, 174, 21, "MG | LEADS | CBO | FRANQUIA | FORMULÁRIO", "m3"),
      entity("meta_ads", "group", "mg4", "Condomínios | Capitais", 252.67, 12261, 139, 17, "MG | LEADS | CBO | CONDOMÍNIOS", "m1"),
      entity("meta_ads", "group", "mg5", "Visitantes do site | 30 dias", 209.1, 9270, 213, 0, "MG | RECONHECIMENTO | REMARKETING", "m5"),
    ],
  },
  meta_ad: {
    total_count: 12,
    next_cursor: null,
    items: [
      entity("meta_ads", "ad", "ma1", "Vídeo | Mercado no condomínio", 229.42, 11030, 143, 23, "Síndicos | Sudeste | 30-60", "mg1"),
      entity("meta_ads", "ad", "ma2", "Carrossel | Conveniência 24h", 216.08, 10421, 132, 18, "Condomínios | Capitais", "mg4"),
      entity("meta_ads", "ad", "ma3", "Estático | Seja um franqueado", 207.37, 9810, 129, 15, "Franqueados | Lookalike 2%", "mg2"),
      entity("meta_ads", "ad", "ma4", "Reels | Renda recorrente", 198.92, 9450, 128, 14, "Empreendedores | Interesses", "mg3"),
      entity("meta_ads", "ad", "ma5", "Depoimento | Síndico parceiro", 184.31, 8870, 120, 12, "Síndicos | Sudeste | 30-60", "mg1"),
      entity("meta_ads", "ad", "ma6", "Imagem | Sua loja completa", 176.72, 8020, 111, 8, "Visitantes do site | 30 dias", "mg5"),
      entity("meta_ads", "ad", "ma7", "Vídeo | Rotina sem filas", 154.37, 7160, 96, 7, "Condomínios | Capitais", "mg4"),
      entity("meta_ads", "ad", "ma8", "Carrossel | Produtos essenciais", 143.21, 6640, 88, 6, "Síndicos | Sudeste | 30-60", "mg1"),
      entity("meta_ads", "ad", "ma9", "Reels | Empreender perto", 131.9, 6130, 81, 5, "Franqueados | Lookalike 2%", "mg2"),
      entity("meta_ads", "ad", "ma10", "Estático | Seu condomínio completo", 118.78, 5620, 74, 4, "Condomínios | Capitais", "mg4"),
      entity("meta_ads", "ad", "ma11", "Depoimento | Mais praticidade", 104.5, 5110, 67, 3, "Empreendedores | Interesses", "mg3"),
      entity("meta_ads", "ad", "ma12", "Imagem | Conheça a franquia", 92.14, 4680, 60, 2, "Franqueados | Lookalike 2%", "mg2"),
    ],
  },
};
